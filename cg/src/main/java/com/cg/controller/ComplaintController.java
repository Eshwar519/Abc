...
public class ComplaintController {
	...
	@Autowired
	ComplaintServiceInteface cs;			// Object of Complaint Service

	
	  @GetMapping("getEngineer/{id}") 		// Getting Engineer Id as input and passing to methods
	  ...
	  @PostMapping("bookComplaint")			// Getting Complaint details from u
	  ...
	  public List<Complaints> getClientAllOpenComplaints(@RequestBody Client e)throws InvalidClientIdException{
	  ...
	  public String changeComplaintStatus(@RequestBody Complaint cp)throws InvalidComplaintIdException {
