...
public class EngineerController {
	...
	public List<Complaints> getComplaintsByStatus(@RequestBody Engineer e, @PathVariable("status") String status ){
		List<Complaint> c= es.getAllOpenComplaintsService(e, status);
