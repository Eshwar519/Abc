...
public class ClientService implements ClientServiceInterface {
	...
	@Override
	public String saveClientService(Client c) throws InvalidClientIdException {
	...
	@Override
	public Client clientSignOut(Client c) throws InvalidCredentialsException {
		Optional<Client> c1=cr.findById(c.getClientId());
		if(!signin || c1.isEmpty()) {
