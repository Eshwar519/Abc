...
class HomePageEngineer extends Component {
  ...
  componentDidMount() {
    ...
    EngineerService.getEngineerComplaints(engineer,"Open").then((res) => {
      this.setState({ complaints: res.data });
    });
    console.log(engineer)
    console.log(this.state.rcomplaints)
    console.log(this.state.complaints)
    EngineerService.getEngineerComplaints(engineer,"Closed").then((res) => {
        ...
        <div className="col-4 ml-2">
          ...
          <CardDeck>
            <Card>
              <Card.Body>
                <Card.Title className="text-center">
                  Open Complaints<p className="mt-2" style={{fontSize:65, color: 'yellow'}}>{this.state.complaints.length+this.state.rcomplaints.length}</p>
                  </Card.Title>
              </Card.Body>
            </Card>
            <Card>
